...
const Home = () => {
  return (
    <div className="h-screen w-screen p-5 text-center grid content-center grid-cols-1 relative">
      ...
      <h6 className="text-lg my-2 underline text-blue-400"><a href="https://datdo.notion.site/Proposal-Project-Chiron-4adda27de97d40e18987350b554b8fbb">Checkout our Vision</a></h6>
    </div>
  );
};
